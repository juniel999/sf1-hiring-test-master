...
function HiringTest() {
	...
	const { seconds, minutes, stop, start, reset } = useTimer();
	...
	return (
		<div className="App">
			<header className="App-header">
				...
				<div>
					<h1 className={isVanished ? "d-none" : "d-block"}>
						1. Make this vanish
					</h1>
					<button onClick={handleVanish}>Click me!</button>
				</div>
				...
				<div>
					...
					<div className={isSubmitted ? "d-block" : "d-none"}>
						<h4>Request Sent to DB with below request data</h4>
						<ul>
							<li>UserName: {formValues.username}</li>
							<li>FullName: {formValues.fullname} </li>
